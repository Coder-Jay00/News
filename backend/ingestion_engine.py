...
class IngestionEngine:
    def __init__(self):
        self.sources = {
            "tier2_rss": [
                # --- GENERAL NEWS (Freshness: 12h) ---
                {"url": "https://news.google.com/rss/search?q=world+news+when:12h&hl=en-US&gl=US&ceid=US:en", "category": "World News"},
                {"url": "https://news.google.com/rss/search?q=business+finance+when:12h&hl=en-US&gl=US&ceid=US:en", "category": "Business"},
                {"url": "https://news.google.com/rss/search?q=India+breaking+news+when:12h&hl=en-IN&gl=IN&ceid=IN:en", "category": "India News"},
                {"url": "https://news.google.com/rss/search?q=technology+innovation+when:12h&hl=en-US&gl=US&ceid=US:en", "category": "Technology"},
                {"url": "https://news.google.com/rss/search?q=science+research+when:12h&hl=en-US&gl=US&ceid=US:en", "category": "Science"},
                {"url": "https://news.google.com/rss/search?q=health+medical+when:12h&hl=en-US&gl=US&ceid=US:en", "category": "Health"},
                
                # --- NICHE ---
                {"url": "https://news.google.com/rss/search?q=AI+LLM+OR+Nvidia+when:12h&hl=en-US&gl=US&ceid=US:en", "category": "AI & Frontiers"},
